...
Game.App.prototype._updateDescription = function() {
	...
	switch (key) {
		case "Random-Human": str = "一人用テトリス"; break;
		case "Random-AI": str = "テトリスは部屋を明るくして離れて見てね"; break;
		case "Random-Network": str = "てきとー"; break;
		case "AI-Human": str = "電王戦"; break;
		case "AI-AI": str = "エイリアンvsプレデター"; break;
		case "AI-Network": str = "ズルしてない？"; break;
		case "Human-Human": str = "競い合え！"; break;
		case "Human-AI": str = "人工知能に打ち勝て！"; break;
		case "Human-Network": str = "Multiplayer (attacker)"; break;
		case "Network-Human": str = "Multiplayer (defender)"; break;
		case "Network-AI": str = "なんか動きロボットっぽくない？"; break;
		case "Network-Network": str = "セッティングミスやで"; break;
	}
...
// かすたむ
	"H": {
		color: "#03f",
		avail: 1,
		cells: [new XY(0, 0), new XY(-1, 0), new XY(-1, 1), new XY(-1, -1), new XY(1, 0), new XY(1, 1), new XY(1, -1)]
	},
	"C": {
		color: "#03f",
		avail: 1,
		cells: [new XY(-1, 0), new XY(-1, -1), new XY(0, -1), new XY(1, -1), new XY(-1, 1), new XY(1, 1), new XY(0, 1)]
	},
	
	"S": {
		color: "#03f",
		avail: 1,
		cells: [new XY(0, 0), new XY(-2, 2), new XY(-1, 2), new XY(0, 2), new XY(1, 2), new XY(2, 2), new XY(-2, -2), new XY(-1, -2), new XY(0, -2), new XY(1, -2), new XY(2, -2), new XY(-2, 0), new XY(-1, 0), new XY(0, 0), new XY(1, 0), new XY(2, 0), new XY(-2, 1), new XY(2, 0), new XY(2, -1)]
	}
