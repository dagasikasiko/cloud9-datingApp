...
/* enchant.js v0.7.0 http://enchantjs.com Copyright (c) Ubiquitous Entertainment Inc. Released Under the MIT license. */
...
window.onload = function(){
    ...
    //画像を配列に収納
    var _img = [];
    _img[0] = '/assets/gacha/karada.png'; //karada
    _img[1] = '/assets/gacha/ude.png'; //ude
    _img[2] = '/assets/gacha/ugoki.png'; //ugoki
    _img[3] = '/assets/gacha/tamagougoki.png'; //tamagougoki
    _img[4] = '/assets/gacha/yajirushi.png'; //yajirushi
    _img[5] = '/assets/gacha/mou1kai.gif'; //mou1kai
    _img[6] = '/assets/gacha/dou.png'; //dou
    _img[7] = '/assets/gacha/gin.png'; //gin
    _img[8] = '/assets/gacha/kin.png'; //kin
    _img[9] = '/assets/gacha/haikei.png'; //haikei
    _img[10] = '/assets/gacha/kage.png'; //kage    
    _img[11] = '/assets/gacha/hazureman.png'; //hazureman
    ...
    game.makeScene1 = function() {
        ...
        var e = document.getElementById('stampgacha');
        var stampgacha = e.getAttribute('data-stampgacha-id');
        
        
        if(stampgacha = "hazure"){  //はずれだった場合
            bgImage = _img[11];
        }else{                      //あたってた場合
            document.write(stampgacha.image.url);
        }
