...
Game.App.prototype._updateDescription = function() {
	...
	switch (key) {
		case "Random-Human": str = "1人テトリスモード"; break;
		case "Random-AI": str = "CPUまかせ"; break;
		case "Random-Network": str = "ランダムブロック！"; break;
		case "AI-Human": str = "CPUに挑戦！"; break;
		case "AI-AI": str = "CPU vs CPU"; break;
		case "AI-Network": str = "ズルしてない？"; break;
		case "Human-Human": str = "１PCで対戦！"; break;
		case "Human-AI": str = "人工知能に打ち勝て！"; break;
		case "Human-Network": str = "通信対戦 (攻撃側)"; break;
		case "Network-Human": str = "通信対戦 (防御側)"; break;
		case "Network-AI": str = "操作してなくない？"; break;
		case "Network-Network": str = "セッティングミス"; break;
	}
...
Game.App.prototype._createBackground = function() {
	...
	var piece = new Game.Piece("H");

	piece.xy = new XY(2, 2);
	piece.build(this._dom.setup);
	
	var piece = new Game.Piece("C");
