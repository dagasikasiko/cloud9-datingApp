...
Game.Piece.DEF = {
	"o": {
		color: "#333",
		avail: Math.floor( Math.random() * 5 ) + 2,
		cells: [new XY(0, 0), new XY(-1, 0), new XY(0, -1), new XY(-1, -1)]
	},
	"i": {
		color: "#6cf",
		avail: Math.floor( Math.random() * 5 ) + 1,
...
,	"H": {
		color: "#000080",
		avail: 1,
		cells: [new XY(0, 0), new XY(-1, 0), new XY(-2, 0), new XY(-2, 1), new XY(-2, 2), new XY(-2, -1), new XY(-2, -2), new XY(1, 0), new XY(2, 0), new XY(2, -1), new XY(2, -2), new XY(2, 1), new XY(2, 2)]
	},
	"C": {
		color: "#ff0000",
		avail: 1,
		cells: [new XY(-2, 0), new XY(-2, -1),  new XY(-2, -2), new XY(-2, 1), new XY(-2, 2), new XY(-1, -2), new XY(-1, 2), new XY(0, -2), new XY(0, 2), new XY(1, -2), new XY(1, 2), new XY(2, -2), new XY(2, 2)]
	},
